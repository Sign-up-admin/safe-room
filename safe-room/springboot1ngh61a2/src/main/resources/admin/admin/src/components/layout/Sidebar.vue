...
// Methods
const toggleSidebar = () => { // eslint-disable-line @typescript-eslint/no-unused-vars
  emit('toggle-sidebar')
}
</script>

<style scoped>
/* Sidebar specific styles will be added here later */
</style>
