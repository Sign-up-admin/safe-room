<template>
  ...
  <div
    ...
    style="
      --layout-offset-y: 6px;
      --composer-container-height: 260px;
      --sidebar-header-secondary-buttons-collapsed-width: 0px;
      --header-controls-inline-start-width: 0px;
    "
  >
    <div class="sr-only">
    ...
    <div
      class="flex h-full overflow-hidden bg-sidebar-light dark:bg-sidebar-dark"
    >
      <div
        ...
        >
            ...
            <div class="relative">
              ...
              >
                ...
                >
                  ...
                  <div
                    class="flex rounded-xl max-md:hover:bg-black/3 max-md:dark:hover:bg-white/5 hover:bg-black/3 dark:hover:bg-white/5"
                  >
                    <button
          ...
          <div class="overflow-hidden" style="opacity: 1">
            <div class="h-dvh px-0.5 pb-0.5 pt-1 w-sidebar">
              <div
                class="t-custom-scrollbar h-full overflow-x-hidden overflow-y-auto"
              >
                <div
                  class="flex min-h-full w-full flex-col px-1 justify-between"
                >
                  <div
                    class="bg-sidebar-light dark:bg-sidebar-dark before:pointer-events-none before:absolute before:h-10 before:w-full before:from-sidebar-light before:to-transparent dark:before:from-sidebar-dark pointer-events-none sticky top-0 z-10 pb-3 pt-[52px]"
                    style="transform: none; transform-origin: 50% 50% 0px"
                  >
                    <div
                      class="bg-sidebar-light dark:bg-sidebar-dark pointer-events-auto relative flex flex-col items-start gap-0.5 pt-4"
                    >
                      <div
                            ...
                            ><span class="flex min-w-0 gap-2.5"
                              ...
                              ><span
                                ...
                                ><span
                                  ...
                                  >Imagine
                                  <div
                                    class="flex h-4 shrink-0 items-center rounded px-1.5 text-2xs bg-accent-350/30 text-accent-650 dark:bg-accent-450/30"
                                  >
                                    New
                                  </div></span
                                ></span
                    ...
                    <div class="relative flex grow flex-col py-5">
                      ...
                      >
                        ...
                        <div
                          ...
                          tabindex="0"
                          aria-selected="false"
                          aria-label="Today, Creating a Custom Image Concept"
                        >
                          <div
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Creating a Custom Image Concept
                              </p>
                            </div>
                            <button
                              type="button"
      ...
      >
        <div class="relative size-full overflow-hidden">
          ...
          <div class="relative size-full overflow-hidden md:rounded-container">
            <div
              class="scrollbar-stable flex size-full flex-col items-center overflow-y-auto overflow-x-hidden overscroll-contain text-foreground-800 sm:min-w-secondary-panel-slim lg:min-w-secondary-panel"
              data-testid="landing-page"
            >
              <div
                class="pointer-events-none sticky top-0 w-full z-20"
                style="opacity: 1"
              >
                <div
                ...
                >
                  <div style="opacity: 1">
                    <div
                      class="pointer-events-auto absolute inset-0 h-16 overflow-hidden backdrop-blur-2xl backdrop-saturate-200 bg-background-150/95 dark:bg-background-150/90"
                    ></div>
                  </div>
                </div>
              </div>
              <div
                data-tabster='{"mover":{"cyclic":false,"direction":1,"memorizeCurrent":true,"tabbable":true}}'
                class="mb-[var(--composer-container-height)] grow px-6 max-w-chat w-full"
                style="opacity: 1"
              >
                <div class="relative pt-10 min-h-[60px] sm:min-h-[120px]"></div>
                <div
                  class="mt-2 flex flex-col items-start text-pretty pe-0 sm:absolute sm:inset-x-0 sm:inset-y-0 sm:mx-auto sm:mt-0 sm:max-w-chat sm:px-4 sm:pb-[calc(var(--composer-container-height))]"
                  style="opacity: 1"
                >
                  <div
                    class="order-1 flex w-full flex-col gap-2 sm:top-0 sm:h-full sm:justify-center"
                  >
                    <div
                      class="flex w-full flex-col items-start justify-start sm:justify-end sm:mb-8 sm:h-[100px] text-2xl sm:ps-2"
                      data-testid="launch-greeting"
                    >
                      <h1>Hey, nice to see you. What&rsquo;s new?</h1>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div
              class="absolute flex end-6 origin-top-right flex-col items-end rtl:origin-top-left top-6 -me-[14px] -mt-[14px] z-30"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span class="px-1 text-sm">Design a logo</span></button
                      ><button
                        type="button"
                        class="shadow-none dark:shadow-none relative flex items-center text-sm min-h-10 px-3 py-2 gap-x-2 rounded-xl after:rounded-xl after:absolute after:inset-0 after:pointer-events-none after:border after:border-transparent after:contrast-more:border-2 outline-2 outline-offset-1 focus-visible:z-[1] focus-visible:outline focus-visible:outline-stroke-900 text-foreground-550 active:text-foreground-350 dark:text-foreground-600 active:dark:text-foreground-550 bg-white/30 safe-hover:bg-black/3 active:bg-black/2 dark:bg-black/3 dark:safe-hover:bg-white/5 dark:active:bg-white/3 border-[1px] border-black/8 dark:border-white/8 min-w-fit"
                      ...
                      >
                        <span class="px-1 text-sm">Get advice</span></button
                      ><button
                        type="button"
                        class="shadow-none dark:shadow-none relative flex items-center text-sm min-h-10 px-3 py-2 gap-x-2 rounded-xl after:rounded-xl after:absolute after:inset-0 after:pointer-events-none after:border after:border-transparent after:contrast-more:border-2 outline-2 outline-offset-1 focus-visible:z-[1] focus-visible:outline focus-visible:outline-stroke-900 text-foreground-550 active:text-foreground-350 dark:text-foreground-600 active:dark:text-foreground-550 bg-white/30 safe-hover:bg-black/3 active:bg-black/2 dark:bg-black/3 dark:safe-hover:bg-white/5 dark:active:bg-white/3 border-[1px] border-black/8 dark:border-white/8 min-w-fit"
    ...
    <dialog
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="芦r2g禄"
      style="opacity: 0"
    ></dialog>
    <dialog
      class="fixed inset-0 m-auto rounded-4xl border border-white/10 bg-background-150 text-foreground-800 shadow-xl dark:bg-background-250 backdrop:bg-background-850/30 dark:backdrop:bg-background-150/70 t-custom-scrollbar"
      role="dialog"
      aria-modal="true"
      aria-label="Get things done with Actions"
      style="opacity: 0"
    ></dialog>
    <div id="inAppFeedbackOcv"></div>
    <div id="popoverPortal"></div>
    <div
      class="absolute start-[-9999px] top-[-9999px] size-px overflow-hidden"
    ></div>
  </div>
</template>

<script setup lang="ts">
// Copilot home page component - exact match to Microsoft Copilot reference
</script>
