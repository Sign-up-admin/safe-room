...
const pJS = function (tag_id, params) {
  ...
  pJS.fn.vendors.eventsListeners = function () {
    ...
    if (pJS.interactivity.events.onhover.enable || pJS.interactivity.events.onclick.enable) {
      /* el on mousemove */
      pJS.interactivity.el.addEventListener('mousemove', (_e) => {
        let pos_x, pos_y
        if (pJS.interactivity.el == window) {
          pos_x = _e.clientX
          pos_y = _e.clientY
        } else {
          pos_x = _e.offsetX || _e.clientX
          pos_y = _e.offsetY || _e.clientY
        }
      ...
      /* el on onmouseleave */
      pJS.interactivity.el.addEventListener('mouseleave', (_e) => {
  ...
  pJS.fn.vendors.createSvgImg = function (p) {
    ...
    const svgXml = pJS.tmp.source_svg,
      ...
      coloredSvgXml = svgXml.replace(rgbHex, (_m, _r, _g, _b) => {
        let color_value
        if (p.color.rgb) {
