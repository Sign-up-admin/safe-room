...
describe('jQuery Initialization Tests', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks()
    // Note: jQuery is mocked globally in vitest.setup.ts
    // We don't delete it here as it's part of our test environment
  })
  ...
  it('should handle jQuery loaded', () => {
    // 测试 jQuery 已加载的行为 (通过全局mock)
