...
public class HuiyuankaController {
    ...
    public R page(@RequestParam Map<String, Object> params,HuiyuankaEntity huiyuanka,
        ...
        QueryWrapper<HuiyuankaEntity> ew = new QueryWrapper<HuiyuankaEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        HuiyuankaEntity huiyuanka = huiyuankaService.getById(id);
    ...
    public R save(@RequestBody HuiyuankaEntity huiyuanka, HttpServletRequest request){
        ...
        huiyuankaService.save(huiyuanka);
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        huiyuankaService.removeByIds(Arrays.asList(ids));
        return R.ok();
    }
