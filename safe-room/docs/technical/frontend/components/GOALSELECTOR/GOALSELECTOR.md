...
```html
<!-- HTML中使用 -->
<custom-goal-selector property-name="value">
...
import 'custom-goal-selector' from '@/components/web-components/GoalSelector.js'
...
```css
/* 暗色主题 */
.dark-theme custom-goal-selector {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-goal-selector {
