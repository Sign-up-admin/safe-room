...
```html
<!-- HTML中使用 -->
<custom-safe-html property-name="value">
...
import 'custom-safe-html' from '@/components/web-components/SafeHtml.js'
...
```css
/* 暗色主题 */
.dark-theme custom-safe-html {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-safe-html {
