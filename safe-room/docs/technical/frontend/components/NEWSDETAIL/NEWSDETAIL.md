...
```html
<!-- HTML中使用 -->
<custom-news-detail property-name="value">
...
import 'custom-news-detail' from '@/components/web-components/NewsDetail.js'
...
```css
/* 暗色主题 */
.dark-theme custom-news-detail {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-news-detail {
