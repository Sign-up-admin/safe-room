...
- **标签名**: `<custom-notification-center>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-notification-center property-name="value">
...
import 'custom-notification-center' from '@/components/web-components/NotificationCenter.js'
...
```css
/* 暗色主题 */
.dark-theme custom-notification-center {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-notification-center {
