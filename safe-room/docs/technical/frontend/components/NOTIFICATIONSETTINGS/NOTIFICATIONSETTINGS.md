...
### 基本信息
- **组件名称**: `NotificationSettings`
- **标签名**: `<custom-notification-settings>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-notification-settings property-name="value">
...
import 'custom-notification-settings' from '@/components/web-components/NotificationSettings.js'
...
```css
/* 暗色主题 */
.dark-theme custom-notification-settings {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-notification-settings {
