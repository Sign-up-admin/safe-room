...
| 方法名 | 参数 | 返回值 | 描述 |
|--------|------|--------|------|
| onTake | `()` | `void` | onTake属性 |
| getCompetence | `()` | `void` | getCompetence属性 |--------|------|--------|------|
...
```html
<!-- HTML中使用 -->
<custom-camera-upload property-name="value">
...
import 'custom-camera-upload' from '@/components/web-components/CameraUpload.js'
...
```css
/* 暗色主题 */
.dark-theme custom-camera-upload {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-camera-upload {
