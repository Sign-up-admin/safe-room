...
### 基本信息
- **组件名称**: `ModuleDetailPage`
- **标签名**: `<custom-module-detail-page>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-module-detail-page property-name="value">
  <div slot="named-slot">内容</div>
</custom-module-detail-page>
```
...
import 'custom-module-detail-page' from '@/components/web-components/ModuleDetailPage.js'
...
```css
/* 暗色主题 */
.dark-theme custom-module-detail-page {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-module-detail-page {
