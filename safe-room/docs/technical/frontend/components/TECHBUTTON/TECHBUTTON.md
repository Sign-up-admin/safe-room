...
```html
<!-- HTML中使用 -->
<custom-tech-button property-name="value">
...
import 'custom-tech-button' from '@/components/web-components/TechButton.js'
...
```css
/* 暗色主题 */
.dark-theme custom-tech-button {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-tech-button {
