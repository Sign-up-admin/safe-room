...
### 基本信息
- **组件名称**: `jianshenkecheng`
- **标签名**: `<custom-jianshenkecheng>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-jianshenkecheng property-name="value">
  <div slot="named-slot">内容</div>
</custom-jianshenkecheng>
```
...
import 'custom-jianshenkecheng' from '@/components/web-components/jianshenkecheng.js'
...
```css
/* 暗色主题 */
.dark-theme custom-jianshenkecheng {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-jianshenkecheng {
