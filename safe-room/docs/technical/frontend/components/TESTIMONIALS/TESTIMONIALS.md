...
```html
<!-- HTML中使用 -->
<custom-testimonials property-name="value">
...
import 'custom-testimonials' from '@/components/web-components/Testimonials.js'
...
```css
/* 暗色主题 */
.dark-theme custom-testimonials {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-testimonials {
