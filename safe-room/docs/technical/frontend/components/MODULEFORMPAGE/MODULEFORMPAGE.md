...
```html
<!-- HTML中使用 -->
<custom-module-form-page property-name="value">
  <div slot="named-slot">内容</div>
</custom-module-form-page>
```
...
import 'custom-module-form-page' from '@/components/web-components/ModuleFormPage.js'
...
```css
/* 暗色主题 */
.dark-theme custom-module-form-page {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-module-form-page {
