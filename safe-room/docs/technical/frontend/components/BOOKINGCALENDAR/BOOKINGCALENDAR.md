...
### 基本信息
- **组件名称**: `BookingCalendar`
- **标签名**: `<custom-booking-calendar>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-booking-calendar property-name="value">
...
import 'custom-booking-calendar' from '@/components/web-components/BookingCalendar.js'
...
```css
/* 暗色主题 */
.dark-theme custom-booking-calendar {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-booking-calendar {
