...
### 基本信息
- **组件名称**: `RecommendationCard`
- **标签名**: `<custom-recommendation-card>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-recommendation-card property-name="value">
...
import 'custom-recommendation-card' from '@/components/web-components/RecommendationCard.js'
...
```css
/* 暗色主题 */
.dark-theme custom-recommendation-card {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-recommendation-card {
