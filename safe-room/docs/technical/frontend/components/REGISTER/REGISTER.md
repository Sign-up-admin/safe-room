...
```html
<!-- HTML中使用 -->
<custom-register property-name="value">
...
import 'custom-register' from '@/components/web-components/Register.js'
...
```css
/* 暗色主题 */
.dark-theme custom-register {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-register {
