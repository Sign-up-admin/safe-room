...
### 基本信息
- **组件名称**: `DiscussionComposer`
- **标签名**: `<custom-discussion-composer>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-discussion-composer property-name="value">
  <div slot="named-slot">内容</div>
</custom-discussion-composer>
```
...
import 'custom-discussion-composer' from '@/components/web-components/DiscussionComposer.js'
...
```css
/* 暗色主题 */
.dark-theme custom-discussion-composer {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-discussion-composer {
