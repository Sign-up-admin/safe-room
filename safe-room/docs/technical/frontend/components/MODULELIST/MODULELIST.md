...
```html
<!-- HTML中使用 -->
<custom-module-list property-name="value">
...
import 'custom-module-list' from '@/components/web-components/ModuleList.js'
...
```css
/* 暗色主题 */
.dark-theme custom-module-list {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-module-list {
