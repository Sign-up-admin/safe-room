...
### 基本信息
- **组件名称**: `SchedulePlanner`
- **标签名**: `<custom-schedule-planner>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-schedule-planner property-name="value">
...
import 'custom-schedule-planner' from '@/components/web-components/SchedulePlanner.js'
...
```css
/* 暗色主题 */
.dark-theme custom-schedule-planner {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-schedule-planner {
