...
| 方法名 | 参数 | 返回值 | 描述 |
|--------|------|--------|------|
| timetableClick | `()` | `void` | timetableClick属性 |
| emit | `()` | `void` | emit属性 |--------|------|--------|------|
...
```html
<!-- HTML中使用 -->
<custom-timeable property-name="value">
...
import 'custom-timeable' from '@/components/web-components/Timeable.js'
...
```css
/* 暗色主题 */
.dark-theme custom-timeable {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-timeable {
