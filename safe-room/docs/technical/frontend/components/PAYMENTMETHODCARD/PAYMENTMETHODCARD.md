...
### 基本信息
- **组件名称**: `PaymentMethodCard`
- **标签名**: `<custom-payment-method-card>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-payment-method-card property-name="value">
...
import 'custom-payment-method-card' from '@/components/web-components/PaymentMethodCard.js'
...
```css
/* 暗色主题 */
.dark-theme custom-payment-method-card {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-payment-method-card {
