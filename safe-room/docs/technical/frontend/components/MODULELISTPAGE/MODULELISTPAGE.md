...
```html
<!-- HTML中使用 -->
<custom-module-list-page property-name="value">
...
import 'custom-module-list-page' from '@/components/web-components/ModuleListPage.js'
...
```css
/* 暗色主题 */
.dark-theme custom-module-list-page {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-module-list-page {
