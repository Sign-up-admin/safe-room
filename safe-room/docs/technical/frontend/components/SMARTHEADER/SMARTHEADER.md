...
```html
<!-- HTML中使用 -->
<custom-smart-header property-name="value">
...
import 'custom-smart-header' from '@/components/web-components/SmartHeader.js'
...
```css
/* 暗色主题 */
.dark-theme custom-smart-header {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-smart-header {
