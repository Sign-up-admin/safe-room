...
```html
<!-- HTML中使用 -->
<custom-mobile-form property-name="value">
...
import 'custom-mobile-form' from '@/components/web-components/MobileForm.js'
...
```css
/* 暗色主题 */
.dark-theme custom-mobile-form {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-mobile-form {
