...
```html
<!-- HTML中使用 -->
<custom-newstype-detail property-name="value">
  <div slot="named-slot">内容</div>
</custom-newstype-detail>
```
...
import 'custom-newstype-detail' from '@/components/web-components/newstypeDetail.js'
...
```css
/* 暗色主题 */
.dark-theme custom-newstype-detail {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-newstype-detail {
