...
### 基本信息
- **组件名称**: `Equipment3DViewer`
- **标签名**: `<custom-equipment3dviewer>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-equipment3dviewer property-name="value">
  <div slot="named-slot">内容</div>
</custom-equipment3dviewer>
```
...
import 'custom-equipment3dviewer' from '@/components/web-components/Equipment3DViewer.js'
...
```css
/* 暗色主题 */
.dark-theme custom-equipment3dviewer {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-equipment3dviewer {
