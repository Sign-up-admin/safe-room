...
```html
<!-- HTML中使用 -->
<custom-payment-stepper property-name="value">
  <div slot="named-slot">内容</div>
</custom-payment-stepper>
```
...
import 'custom-payment-stepper' from '@/components/web-components/PaymentStepper.js'
...
```css
/* 暗色主题 */
.dark-theme custom-payment-stepper {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-payment-stepper {
