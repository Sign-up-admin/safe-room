...
```html
<!-- HTML中使用 -->
<custom-topic-cloud property-name="value">
...
import 'custom-topic-cloud' from '@/components/web-components/TopicCloud.js'
...
```css
/* 暗色主题 */
.dark-theme custom-topic-cloud {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-topic-cloud {
