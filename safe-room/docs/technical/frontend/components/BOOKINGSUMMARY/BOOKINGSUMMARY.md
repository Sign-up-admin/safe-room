...
```html
<!-- HTML中使用 -->
<custom-booking-summary property-name="value">
...
import 'custom-booking-summary' from '@/components/web-components/BookingSummary.js'
...
```css
/* 暗色主题 */
.dark-theme custom-booking-summary {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-booking-summary {
