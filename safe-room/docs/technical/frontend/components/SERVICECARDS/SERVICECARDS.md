...
```html
<!-- HTML中使用 -->
<custom-service-cards property-name="value">
...
import 'custom-service-cards' from '@/components/web-components/ServiceCards.js'
...
```css
/* 暗色主题 */
.dark-theme custom-service-cards {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-service-cards {
