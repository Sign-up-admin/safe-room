...
```html
<!-- HTML中使用 -->
<custom-aiden zhang property-name="value">
...
import 'custom-aiden zhang' from '@/components/web-components/Aiden Zhang.js'
...
```css
/* 暗色主题 */
.dark-theme custom-aiden zhang {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-aiden zhang {
