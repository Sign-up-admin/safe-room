...
| 方法名 | 参数 | 返回值 | 描述 |
|--------|------|--------|------|
| onEditorBlur | `()` | `void` | onEditorBlur属性 |--------|------|--------|------|
...
```html
<!-- HTML中使用 -->
<custom-editor property-name="value">
...
import 'custom-editor' from '@/components/web-components/Editor.js'
...
```css
/* 暗色主题 */
.dark-theme custom-editor {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-editor {
