...
```html
<!-- HTML中使用 -->
<custom-course-card property-name="value">
...
import 'custom-course-card' from '@/components/web-components/CourseCard.js'
...
```css
/* 暗色主题 */
.dark-theme custom-course-card {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-course-card {
