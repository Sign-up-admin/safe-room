...
```html
<!-- HTML中使用 -->
<custom-requirements property-name="value">
...
import 'custom-requirements' from '@/components/web-components/Requirements.js'
...
```css
/* 暗色主题 */
.dark-theme custom-requirements {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-requirements {
