...
### 基本信息
- **组件名称**: `NotificationToast`
- **标签名**: `<custom-notification-toast>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-notification-toast property-name="value">
...
import 'custom-notification-toast' from '@/components/web-components/NotificationToast.js'
...
```css
/* 暗色主题 */
.dark-theme custom-notification-toast {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-notification-toast {
