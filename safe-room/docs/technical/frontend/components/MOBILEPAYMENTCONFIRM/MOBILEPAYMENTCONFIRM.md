...
### 基本信息
- **组件名称**: `MobilePaymentConfirm`
- **标签名**: `<custom-mobile-payment-confirm>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-mobile-payment-confirm property-name="value">
  <div slot="named-slot">内容</div>
</custom-mobile-payment-confirm>
```
...
import 'custom-mobile-payment-confirm' from '@/components/web-components/MobilePaymentConfirm.js'
...
```css
/* 暗色主题 */
.dark-theme custom-mobile-payment-confirm {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-mobile-payment-confirm {
