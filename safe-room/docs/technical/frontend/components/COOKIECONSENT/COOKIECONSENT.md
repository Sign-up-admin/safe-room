...
```html
<!-- HTML中使用 -->
<custom-cookie-consent property-name="value">
...
import 'custom-cookie-consent' from '@/components/web-components/CookieConsent.js'
...
```css
/* 暗色主题 */
.dark-theme custom-cookie-consent {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-cookie-consent {
