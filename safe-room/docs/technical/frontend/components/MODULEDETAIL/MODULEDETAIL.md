...
```html
<!-- HTML中使用 -->
<custom-module-detail property-name="value">
...
import 'custom-module-detail' from '@/components/web-components/ModuleDetail.js'
...
```css
/* 暗色主题 */
.dark-theme custom-module-detail {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-module-detail {
