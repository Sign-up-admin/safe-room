...
### 基本信息
- **组件名称**: `AdvancedFilters`
- **标签名**: `<custom-advanced-filters>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-advanced-filters property-name="value">
...
import 'custom-advanced-filters' from '@/components/web-components/AdvancedFilters.js'
...
```css
/* 暗色主题 */
.dark-theme custom-advanced-filters {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-advanced-filters {
