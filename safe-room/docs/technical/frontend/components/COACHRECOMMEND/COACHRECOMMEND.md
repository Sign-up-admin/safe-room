...
```html
<!-- HTML中使用 -->
<custom-coach-recommend property-name="value">
  <div slot="named-slot">内容</div>
</custom-coach-recommend>
```
...
import 'custom-coach-recommend' from '@/components/web-components/CoachRecommend.js'
...
```css
/* 暗色主题 */
.dark-theme custom-coach-recommend {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-coach-recommend {
