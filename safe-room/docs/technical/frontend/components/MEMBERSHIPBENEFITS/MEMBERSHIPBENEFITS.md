...
### 基本信息
- **组件名称**: `MembershipBenefits`
- **标签名**: `<custom-membership-benefits>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-membership-benefits property-name="value">
...
import 'custom-membership-benefits' from '@/components/web-components/MembershipBenefits.js'
...
```css
/* 暗色主题 */
.dark-theme custom-membership-benefits {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-membership-benefits {
