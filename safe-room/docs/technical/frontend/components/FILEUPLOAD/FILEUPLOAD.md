...
```html
<!-- HTML中使用 -->
<custom-file-upload property-name="value">
...
import 'custom-file-upload' from '@/components/web-components/FileUpload.js'
