...
```html
<!-- HTML中使用 -->
<custom-verify-code property-name="value">
...
import 'custom-verify-code' from '@/components/web-components/VerifyCode.js'
...
```css
/* 暗色主题 */
.dark-theme custom-verify-code {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-verify-code {
