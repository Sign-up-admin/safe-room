...
### 基本信息
- **组件名称**: `DiscussionReplies`
- **标签名**: `<custom-discussion-replies>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-discussion-replies property-name="value">
  <div slot="named-slot">内容</div>
</custom-discussion-replies>
```
...
import 'custom-discussion-replies' from '@/components/web-components/DiscussionReplies.js'
...
```css
/* 暗色主题 */
.dark-theme custom-discussion-replies {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-discussion-replies {
