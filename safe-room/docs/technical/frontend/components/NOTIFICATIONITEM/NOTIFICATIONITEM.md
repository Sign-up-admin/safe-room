...
### 基本信息
- **组件名称**: `NotificationItem`
- **标签名**: `<custom-notification-item>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-notification-item property-name="value">
...
import 'custom-notification-item' from '@/components/web-components/NotificationItem.js'
...
```css
/* 暗色主题 */
.dark-theme custom-notification-item {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-notification-item {
