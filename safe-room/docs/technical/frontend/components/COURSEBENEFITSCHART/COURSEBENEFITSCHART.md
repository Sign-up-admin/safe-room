...
### 基本信息
- **组件名称**: `CourseBenefitsChart`
- **标签名**: `<custom-course-benefits-chart>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-course-benefits-chart property-name="value">
  <div slot="named-slot">内容</div>
</custom-course-benefits-chart>
```
...
import 'custom-course-benefits-chart' from '@/components/web-components/CourseBenefitsChart.js'
...
```css
/* 暗色主题 */
.dark-theme custom-course-benefits-chart {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-course-benefits-chart {
