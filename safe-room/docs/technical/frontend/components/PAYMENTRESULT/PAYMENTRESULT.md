...
```html
<!-- HTML中使用 -->
<custom-payment-result property-name="value">
  <div slot="named-slot">内容</div>
</custom-payment-result>
```
...
import 'custom-payment-result' from '@/components/web-components/PaymentResult.js'
...
```css
/* 暗色主题 */
.dark-theme custom-payment-result {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-payment-result {
