...
| 方法名 | 参数 | 返回值 | 描述 |
|--------|------|--------|------|
| function | `()` | `void` | function属性 |
| toString | `()` | `void` | toString属性 |
| toString | `()` | `void` | toString属性 |
| if | `()` | `void` | if属性 |
| toString | `()` | `void` | toString属性 |--------|------|--------|------|
...
```html
<!-- HTML中使用 -->
<custom-count-down property-name="value">
...
import 'custom-count-down' from '@/components/web-components/CountDown.js'
...
```css
/* 暗色主题 */
.dark-theme custom-count-down {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-count-down {
