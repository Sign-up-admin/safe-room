...
### 基本信息
- **组件名称**: `EquipmentDetail`
- **标签名**: `<custom-equipment-detail>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-equipment-detail property-name="value">
...
import 'custom-equipment-detail' from '@/components/web-components/EquipmentDetail.js'
...
```css
/* 暗色主题 */
.dark-theme custom-equipment-detail {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-equipment-detail {
