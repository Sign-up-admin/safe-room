...
```html
<!-- HTML中使用 -->
<custom-disclaimer property-name="value">
...
import 'custom-disclaimer' from '@/components/web-components/Disclaimer.js'
...
```css
/* 暗色主题 */
.dark-theme custom-disclaimer {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-disclaimer {
