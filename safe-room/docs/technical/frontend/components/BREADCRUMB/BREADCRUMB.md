...
```html
<!-- HTML中使用 -->
<custom-breadcrumb property-name="value">
...
import 'custom-breadcrumb' from '@/components/web-components/Breadcrumb.js'
...
```css
/* 暗色主题 */
.dark-theme custom-breadcrumb {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-breadcrumb {
