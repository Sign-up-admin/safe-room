...
### 基本信息
- **组件名称**: `FloatingServiceButton`
- **标签名**: `<custom-floating-service-button>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-floating-service-button property-name="value">
  <div slot="named-slot">内容</div>
</custom-floating-service-button>
```
...
import 'custom-floating-service-button' from '@/components/web-components/FloatingServiceButton.js'
...
```css
/* 暗色主题 */
.dark-theme custom-floating-service-button {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-floating-service-button {
