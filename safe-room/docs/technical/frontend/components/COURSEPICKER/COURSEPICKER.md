...
```html
<!-- HTML中使用 -->
<custom-course-picker property-name="value">
...
import 'custom-course-picker' from '@/components/web-components/CoursePicker.js'
...
```css
/* 暗色主题 */
.dark-theme custom-course-picker {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-course-picker {
