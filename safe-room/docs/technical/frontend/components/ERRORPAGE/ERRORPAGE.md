...
```html
<!-- HTML中使用 -->
<custom-error-page property-name="value">
...
import 'custom-error-page' from '@/components/web-components/ErrorPage.js'
...
```css
/* 暗色主题 */
.dark-theme custom-error-page {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-error-page {
