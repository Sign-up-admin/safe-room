...
```html
<!-- HTML中使用 -->
<custom-membership-card property-name="value">
...
import 'custom-membership-card' from '@/components/web-components/MembershipCard.js'
...
```css
/* 暗色主题 */
.dark-theme custom-membership-card {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-membership-card {
