...
```html
<!-- HTML中使用 -->
<custom-module-form property-name="value">
...
import 'custom-module-form' from '@/components/web-components/ModuleForm.js'
...
```css
/* 暗色主题 */
.dark-theme custom-module-form {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-module-form {
