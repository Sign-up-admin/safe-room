...
```html
<!-- HTML中使用 -->
<custom-tech-card property-name="value">
...
import 'custom-tech-card' from '@/components/web-components/TechCard.js'
...
```css
/* 暗色主题 */
.dark-theme custom-tech-card {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-tech-card {
