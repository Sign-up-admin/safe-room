...
```html
<!-- HTML中使用 -->
<custom-hero-section property-name="value">
...
import 'custom-hero-section' from '@/components/web-components/HeroSection.js'
...
```css
/* 暗色主题 */
.dark-theme custom-hero-section {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-hero-section {
