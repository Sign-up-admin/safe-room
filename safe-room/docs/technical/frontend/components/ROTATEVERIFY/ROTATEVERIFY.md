...
```html
<!-- HTML中使用 -->
<custom-rotate-verify property-name="value">
  <div slot="named-slot">内容</div>
</custom-rotate-verify>
```
...
import 'custom-rotate-verify' from '@/components/web-components/RotateVerify.js'
...
```css
/* 暗色主题 */
.dark-theme custom-rotate-verify {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-rotate-verify {
