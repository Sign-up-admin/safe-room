...
### 基本信息
- **组件名称**: `MembershipComparison`
- **标签名**: `<custom-membership-comparison>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-membership-comparison property-name="value">
  <div slot="named-slot">内容</div>
</custom-membership-comparison>
```
...
import 'custom-membership-comparison' from '@/components/web-components/MembershipComparison.js'
...
```css
/* 暗色主题 */
.dark-theme custom-membership-comparison {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-membership-comparison {
