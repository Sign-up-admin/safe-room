...
### 基本信息
- **组件名称**: `FavoritesOverview`
- **标签名**: `<custom-favorites-overview>`
- **版本**: 1.0.0
- **状态**: active
...
```html
<!-- HTML中使用 -->
<custom-favorites-overview property-name="value">
  <div slot="named-slot">内容</div>
</custom-favorites-overview>
```
...
import 'custom-favorites-overview' from '@/components/web-components/FavoritesOverview.js'
...
```css
/* 暗色主题 */
.dark-theme custom-favorites-overview {
  --primary-color: #dark-color;
}

/* 浅色主题 */
.light-theme custom-favorites-overview {
